// Web: constellation neural network - "connecting" preset
// 1:1 mathematical port from thinking-orbs

import type { Dot, Line, ModeFrame } from '../types.js';
import { fibDir, finalizeFrame, frac, hashD, lerp, makeProj, radiusScale, vnoise } from './core.js';
