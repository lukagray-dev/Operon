// ============================================================================
// Session Tasks / Todo Panel IPC Wrappers
//
// Hey friend! These helper functions talk directly with our Tauri backend
// to fetch, update, delete, and create session-scoped todos.
// ============================================================================
