...
/// Enables raw mode, alternate screen, mouse capture, and bracketed paste
...
/// Disables raw mode, exits alternate screen, disables mouse capture, disables bracketed paste, and shows cursor
