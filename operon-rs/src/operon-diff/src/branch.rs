...
pub fn current_branch_workspace<P: AsRef<Path>>(
    workspace_root: P,
) -> Result<BranchInfo, DiffError> {
...
pub fn list_branches_workspace<P: AsRef<Path>>(
    workspace_root: P,
...
pub fn switch_branch_workspace<P: AsRef<Path>>(
    workspace_root: P,
    name: &str,
) -> Result<(), DiffError> {
    let repo = discover_repository(workspace_root)?;
...
pub fn delete_branch_workspace<P: AsRef<Path>>(
    workspace_root: P,
    name: &str,
) -> Result<(), DiffError> {
    let repo = discover_repository(workspace_root)?;
