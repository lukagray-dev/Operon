//! Argument parsing for the memory_delete tool.
//!
//! Parses XML attributes parsed by the AI agent's tool-call processor.
//! E.g., <memory_delete id="42">.

use serde_json::Value;

/// Holds the parsed arguments for the memory_delete tool.
#[derive(Debug)]
