// ============================================================================
// Session Tasks / Todo Panel Controller & DOM Renderer for VS Code
// ============================================================================
...
export function renderTodoPanel(aside: HTMLElement): void {
  ...
  // 3. Filter Toolbar Chips
  const filtersBar = createFiltersBar();
  container.appendChild(filtersBar);

  // 4. Scrollable Todo Items List
  ...
  if (filteredTodos.length === 0) {
    ...
    desc.textContent =
      todoPanelState.getTodos().length === 0
        ? 'The assistant will automatically create session tasks here when working.'
