//! WhatsApp channel session queries for the Left Sidebar in Bridge.

use super::types::{SidebarConversationDto, SidebarProjectDto};
use std::path::PathBuf;

/// Query WhatsApp contacts and session JSON files from disk and construct SidebarProjectDto items.
pub async fn query_whatsapp_contacts() -> Result<Vec<SidebarProjectDto>, String> {
                ...
                if !contact_num.is_empty() {
                    ...
                    if !conversations.is_empty() {
                        ...
                        contacts.push(SidebarProjectDto {
                            name: format!("WhatsApp {}", contact_num),
